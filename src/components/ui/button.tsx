...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-background shadow-lg hover:shadow-xl hover:from-amber-400 hover:via-yellow-400 hover:to-amber-500",
        destructive:
          "bg-destructive text-destructive-foreground shadow-lg hover:bg-destructive/90 hover:shadow-xl",
        outline:
          "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-background shadow-md hover:shadow-lg",
        secondary:
          "bg-secondary text-secondary-foreground border border-primary/20 shadow-md hover:bg-secondary/80 hover:border-primary/40 hover:shadow-lg",
