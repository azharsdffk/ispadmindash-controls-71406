...
import { 
  ...
  ExternalLink, RefreshCw, FileText, TrendingUp, ArrowLeft
} from 'lucide-react';
...
export const AdminTechnicianView = () => {
  ...
  const scheduledTicketsCount = tickets.filter(t => t.scheduled_date).length;

  // View specific technician dashboard
    ...
    <div className="space-y-6">
      ...
      {activeView === 'list' && (
        <div className="space-y-4">
          ...
          {/* Quick access to technician dashboards */}
          <Card>
            <CardHeader>
