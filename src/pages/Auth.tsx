...
import { LogIn, Eye, EyeOff, UserPlus, Mail, Lock, User, Phone, Shield, Users, Wrench, UserCog, Building2, ArrowRight } from 'lucide-react';
...
type RoleType = 'client' | 'technician' | 'agent' | 'admin' | null;
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-card/80 backdrop-blur-xl border border-primary/20 rounded-3xl p-8 shadow-2xl shadow-primary/10">
            ...
            {/* شبكة اختيار الدور أو نموذج تسجيل الدخول */}
            {!selectedRole ? (
              <>
              ...
              <>
                ...
                >
                  ...
                  <span>اختيار دور آخر</span>
                </button>

                {/* عرض الدور المحدد */}
                <div className="flex items-center justify-center gap-3 mb-6 p-3 rounded-xl bg-muted/30 border border-border/50">
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        <div>
                          ...
                          <span className="text-muted-foreground text-sm mr-2">• {config.description}</span>
                        </div>
                      </>
                    );
                  })()}
